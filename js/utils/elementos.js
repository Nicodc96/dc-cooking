...
*/
export const crearModal = (numReceta, elementsModalBody, tituloReceta) => {
 ...
 */
export const crearModalButton = (numReceta) => {
 ...
 */
export const crearContenedorModal = (numReceta) => createElementCustom("article", [], "", { "id": `contenedorReceta${numReceta}` });
 ...
 */
export const createElementCustom = (tipoElemento, clases, contenidoTexto, atributos) => {
